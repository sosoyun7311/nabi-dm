package com.dm.nabidm.www.util;
...
public final class Validate {
    ...
    public static boolean isMaxLength(final CharSequence propertyValue, int maxLength) {
        ...
        if(isNotEmpty(propertyValue)) {
            //length = StringUtil.getByteLength(propertyValue.toString());
        }
    ...
    public static boolean isEmail(final CharSequence propertyValue) {
        ...
        boolean match = value
            ...
            .matches("^[0-9a-zA-Z]([-_\\.]?[0-9a-zA-Z-_\\.])*@[0-9a-zA-Z]([-_\\.]?[0-9a-zA-Z])*\\.[a-zA-Z]{2,3}$");
...
//        int length = StringUtil.getByteLength(propertyValue.toString());
//        if(max < 0 && length >= min) {
//            return true;
//        }
...
//        }
     ...
     *
     * @param propertyValue 대상 값
     * @return null, "", 0 이상, 길이가 0이 아닌 경우 <code>true</code>, 아니면 <code>false</code>
     */
    public static boolean isNotEmpty(final Object propertyValue) {
        ...
        // 숫자 확인(숫자는 null이 아니면 무조건 true)
            ...
            // Number prop = (Number) propertyValue;
    ...
    /**
     * 대상 숫자가 <code>null</code>이 아닌지를 확인한다.
     *
     * @param propertyValue 대상 값
     * @return null 이 아니면 <code>true</code>, null이면 <code>false</code>
     */
    ...
    /**
     * 대상 숫자가 <code>null</code> 인지를 확인한다.
     *
     * @param propertyValue 대상 값
     * @return null 인 경우 <code>true</code>, 아니면 <code>false</code>
     */
     ...
     *
     * @param propertyValue 대상 값
     * @return <code>null</code> 또는 length가 0인 경우 <code>true</code>, 아니면 <code>false</code>
     */
    public static boolean isEmpty(final Object[] propertyValue) {
     ...
     * @return
     */
    public static boolean hasNoWhiteSpace(final CharSequence propertyValue) {

        return !(hasWhitespace(propertyValue));
    }
     ...
     */
    public static boolean hasWhitespace(final CharSequence propertyValue) {
